...
6. Clone [this remote repository](https://github.com/datamindedacademy/git_practice_repository). Make sure you use the `SSH` URL when clicking on the `Clone` button, and the git clone command.
